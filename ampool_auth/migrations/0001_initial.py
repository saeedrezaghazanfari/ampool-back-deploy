    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_free_times', models.IntegerField(default=5, verbose_name='تعداد دفعات رایگان')),
                ...
                ('height', models.FloatField(blank=True, null=True, verbose_name='قد')),
                ('address', models.TextField(blank=True, null=True, verbose_name='آدرس محل زندگی شما')),
                ('location_x', models.FloatField(blank=True, null=True, verbose_name='مقیاس ایکس محل زندگی شما')),
                ('location_y', models.FloatField(blank=True, null=True, verbose_name='مقیاس ایگرگ محل زندگی شما')),
                ...
                ('is_doctor', models.BooleanField(default=False, verbose_name='آیا این این کاربر مقام پزشک دارد؟')),
                ('is_supporter', models.BooleanField(default=False, verbose_name='آیا این این کاربر مقام پشتیبان دارد؟')),
